...
This adapter maps the shared Architecture Transform skill to Codex. Claude Code uses the sibling `claude-code.md` adapter; both execute the same strategic and implementation workflow.
